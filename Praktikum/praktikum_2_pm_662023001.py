# -*- coding: utf-8 -*-
"""Praktikum 2_PM_662023001.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1I_n62Mrd8to50sEhfdkmFbp5_OKXXcei
"""
...
V = system(T) #Arah vertikal menghikuti sistem persamaan diferensial

#Plot medan cektor menggunakan streamplot
plt.figure(figsize=(7, 5))
plt.streamplot(t, T, U, V, color = 'pink')
